  ...
  return (
    <div className="w-[240px] h-full bg-macsidebar backdrop-blur-mac border-r border-macborder flex flex-col">
      ...
      <div className="px-3 pb-2">
        <button
          onClick={onNewChat}
          className="w-full h-9 rounded-[10px] bg-macblue text-white text-[13px] font-medium flex items-center justify-center gap-1.5 hover:bg-macblue2 active:scale-[0.98] transition"
        >
          <PlusIcon />
          Nieuwe chat
        </button>
      ...
      <div className="px-4 pt-3 pb-1.5 text-[11px] font-semibold text-macsub uppercase tracking-wide">
        Geschiedenis
      </div>
      ...
      <div className="flex-1 overflow-y-auto mac-scroll px-2 pb-2">
        ...
        {chats.map((chat) => (
          <div
            ...
            className={`group flex items-center gap-2 px-3 py-2 rounded-[9px] cursor-pointer text-[13px] mb-0.5 transition ${
      ...
      <div className="border-t border-macborder p-3 flex items-center gap-2">
        ...
        <button
          ...
          title="Instellingen"
          className="w-7 h-7 rounded-full flex items-center justify-center hover:bg-black/[0.06] transition text-macsub"
        >
          <GearIcon />
        </button>
        <button
